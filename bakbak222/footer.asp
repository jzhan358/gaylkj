...
%>
 <!--底部-->
  <div id="foot">
    <p><!--Powered By <a href="http://www.selectersky.cn" target="_blank"><strong>selectersky v<%'=blog_version%></strong></a> CopyRight 2008,--> <strong><%=SiteName%></strong> <a href="http://validator.w3.org/check/referer" target="_blank">xhtml</a> | <a href="http://jigsaw.w3.org/css-validator/validator-uri.html">css</a></p>

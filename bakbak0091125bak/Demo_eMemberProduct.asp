      ...
      <table width="570" border="0" cellpadding="0" cellspacing="0">
        <tr align="left"> 
          ...
          <td width="268" align="left" valign="bottom"> <table width="268" height="34" border="0" cellpadding="0" cellspacing="0">
              <form name="form1" method="post" action="Demo_eMemberProduct.asp">
                <tr> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td align="left" valign="top"> <table width="536" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="table3">
              <%
						sql_type="select * from P_class_small where p_type_e = '" & classType & "' order by p_small_id desc"
              ...
              <tr> 
                ...
                <td align="center" class="line"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="88" align="center" valign="bottom"><a href="eshowMemberProDetail.asp?ProID=<%=rs("p_id")%>"><img src="<%=rs("p_pic")%>" width="90" height="84" border="0"></a></td>
                    </tr>
                    <tr> 
                      <td height="25" align="center" class="font9">
					  Name：<A href="eshowMemberProDetail.asp?ProID=<%=rs("p_id")%>" class="money"><%=rs("p_name_e")%></A><br>
					  No：<%=rs("p_spec_e")%>
                      </td>
                    </tr>
                  </table>
            ...
            <table width="100%">
              <tr bgcolor="#FFFFFF"> 
                <td height="25" colspan="7"> 
                  <div align="center" class="number"><span class="font3">page: <b><font color=red><%=pagecount%></font>/<%=rs.pagecount%></b></span> 

...
<TABLE width="100%" border=0 cellPadding=0 cellSpacing=0>
  <TBODY>
      ...
      <TD align="center"> <font color=ff6600><b><%=rs("news_title")%></b></font></TD>
                <TD width="193" align="center"><font color=#999999>日期：<%=rs("news_date")%> 查看：<%=rs("news_count")%></font></TD>
              </TR>
              <TR>
          ...
          <tr>
			  ...
			  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="85%">&nbsp;</td>
                    <td width="15%"><img src="images/news_back.gif" width="8" height="5"><a href="javascript:history.back()"> 返回</a></td>  
                  </tr>
                </table></TD>
                                    </tr>
                                  </table>

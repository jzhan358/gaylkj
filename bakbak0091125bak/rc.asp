...
<HTML>
<HEAD>
<TITLE>广州市广安娱乐电子有限公司-人才招聘-【广安娱乐科技】全程用心！一流服务！</TITLE>
...
<!--#include file="left.asp" -->
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="60"><img src="images/zhp.gif" width="565" height="45"></td>
      </tr>
      <tr>
        <td>
...
news_type = "人才招聘"
sql="select top 20 news.* from news,News_Class where news.news_class_id=news_class.news_id and news_language=0 and news_type = '人才招聘' order by news_date desc"
          ...
          <tr>
            ...
            align=center border=0>
                <TBODY>
                  <TR class=font>
                    <TD width=188>
                      <DIV align=center class="t-02">共有<%= totalRecs %>条招聘信息</DIV></TD>
                    <TD width=421>

                                  ...
                                  <TD height=5>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="77%"></td>
                                        <td width="14%" rowspan="3"><img border="0" src="images/co.jpg"></td>
                                      </tr>
                                      <tr>
                                        <td width="77%"><% 
'###############################联系我们#############################
'根据后台简介管理里面的英文栏目名称修改i_type的值,比如是公司简介等,如果后台修改了类别名字,请在这里做相应的修改
sql="select inc_text from inc_info,inc_class where inc_class.i_id=inc_info.inc_class_id and i_type='link'"
set rs=server.createobject("adodb.recordset")
rs.open sql,conn,1,1
if not rs.eof then
 %>        

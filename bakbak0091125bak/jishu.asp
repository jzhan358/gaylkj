...
<HTML>
<HEAD>
<TITLE>广州市广安娱乐-技术资料-【广安娱乐科技】全程用心！一流服务！</TITLE>
<META http-equiv=Content-Type content="text/html; charset=gb2312">
<META content="MSHTML 6.00.2900.2802" name=GENERATOR>
<meta name="Keywords" content="技术资料,公司动态,广安娱乐,游戏机生产,游戏机销售,电脑游戏机配件,超级机板王,卡带,游艺机,百家乐,明星97,老虎机" />
<meta name="Description" content="技术资料,广州市广安娱乐电子有限公司主要是一家从事多年游戏机生产、销售、电脑游戏机配件，集科、工、贸于一体的专业公司，并与台湾资深电玩工程师，合作开发多款新产品。" />
<LINK 
...
<!--#include file="left.asp" -->
 ...
 <% 
 '###############################信息中心#############################
'根据后台信息管理里面的信息列别名称修改news_type的值,比如是业界动态等,如果后台修改了类别名字,请在这里做相应的修改
'news_language=0表示是中文类别的信息，news_language=1表示英文类别的信息
'top 20,表示显示信息的条数，这里为20条
news_type = "技术资料"
strsql="select  news.* from news,News_Class where news.news_class_id=news_class.news_id and news_language=0 and news_type = '"&news_type&"' order by news_date desc"
          ...
          <tr>
            ...
            align=center border=0>
                <TBODY>
                  <TR class=font>
                    <TD width=188>
                      <DIV align=center class="t-02">共有<%= totalRecs %>条信息</DIV></TD>
                    <TD width=421>
                      <DIV align=center class="t-02">共有<%=maxpage%>页 <%=pagesize%>条/页 目前第<%=pageno%>页 　
					  <%if pageno>1 then%>
					  <A href="?pageno=<%=pageno-1%>" class="al">上一页</A><%else%>上一页<%end if%>&nbsp;<%if pageno<maxpage then%><A 
                  href="?pageno=<%=pageno+1%>" class="al">下一页</A><%else%>下一页<%end if%></DIV></TD>

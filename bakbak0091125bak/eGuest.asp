...
%>
                                  ...
                                  <TD height=5>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td width="100%"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
  <form action="Demo_eGuestPost.asp" method="post" name="form0" target="_self">
              <input name="bookpost" type="hidden" value="bookpost">
              <tr>
                
      <td width="40" height="230" align="left" rowspan="9"></td>
                
      <td width="86" height="25" align="left">&nbsp;&nbsp;Title:</td>
                <td width="444" height="25"><input name="m_title" type="text" id="m_title3" size="50" maxlength="50"></td>
              </tr>
              <tr>
                
      <td height="25" align="left" valign="top">&nbsp; Advice:</td>    
                <td height="25"><textarea name="m_text" cols="55" rows="8" id="textarea2" style="font-size:12px"></textarea></td>
              </tr>
              <tr>
                
      <td height="25" align="left">&nbsp;&nbsp;Name:</td>
                <td height="25"><input name="m_name" type="text" id="m_name3" value="guest" size="50" maxlength="50"></td>
              </tr>
              <tr>
                
      <td height="25" align="left">&nbsp;&nbsp;Email:</td>
                <td height="25"><input name="m_email" type="text" id="m_email3" size="50" maxlength="50"></td>
              </tr>
              <tr>
                
      <td height="25" align="left">&nbsp;&nbsp;City:</td>
                <td height="25"><input name="m_city" type="text" id="m_city3" size="50" maxlength="50"></td>
              </tr>
              <tr>
                
      <td height="25" align="left">&nbsp;&nbsp;Address:</td>
                <td height="25"><input name="m_addr" type="text" id="m_addr3" size="50" maxlength="50"></td>
              </tr>
              <tr>
                
      <td height="25" align="left">&nbsp;&nbsp;Telphone:</td>
                <td height="25"><input name="m_tel" type="text" id="m_tel3" size="50" maxlength="50"></td>
              </tr>
              <tr>
                
      <td height="25" align="left">&nbsp;&nbsp;Fax:</td>
                <td height="25"><input name="m_fax" type="text" id="m_fax3" size="50" maxlength="50"></td>
              </tr>
              <tr align="center" valign="middle">
                <td height="30" colspan="2"><input type="submit" name="Submit2" value=" send " class="button"> 

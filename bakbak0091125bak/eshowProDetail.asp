...
%>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <tr> 
                                <td width="100%">&nbsp; &nbsp;<a class="number" href='Demo_eProduct.asp?classtype=<%=rs2("p_type_e")%>&smallclass=<%=rs2("p_small_type_e")%>'><%=rs2("p_small_type_e")%></a></td>        
                              </tr>
                            </table>
                            <%
rs2.movenext
...
%>
                                  ...
                                  <TD height=5>
                                    <table width="100%" height="239" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td> <IMG  
            src="images/op_11.gif"> Product type:<%=rs("p_type_e")%> - <%=rs("p_small_type_e")%></td>   
                                      </tr>
                                      <tr>
                                                              <td height="15"> </td> 
                                      </tr>
				...
				%>
									  <tr>
                                        <td align="center"><a href="<%=pic%>"  target="_blank"><img src="<%=pic%>"  border="0" /></a></td>
                                      </tr>
                                      <tr>
                                        <td align="center"><%=rs("p_epitome_e")%></td>
                                      </tr>
                                      <tr>
                                        <td width="801"><strong>Name:</strong><%=rs("p_name_e")%></td>
                                      </tr>
                                      <tr>
                                        <td><strong>Item:</strong><%=rs("p_spec_e")%></td>
                                      </tr>
                                      <tr>
                                        <td><strong>Description:</strong></td>
                                      </tr>
									  <tr>
                                        <td><%=rs("P_jianjie_e")%></td>
                                      </tr>
                                      <tr>
                                                              <td height="8" align="center">&gt;&gt;<a href="eorder.asp?id=<%=rs("p_id")%>">Order</a>&lt;&lt;</td>
                                      </tr>
                                    </table><%
end if
%>                                                    </TD>

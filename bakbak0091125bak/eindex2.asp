...
<HTML>
<HEAD>
<TITLE>广州市广安娱乐电子有限公司-首页-【广安娱乐科技】全程用心！一流服务！</TITLE>
<META http-equiv=Content-Type content="text/html; charset=gb2312">
<META content="MSHTML 6.00.2900.2802" name=GENERATOR>
<meta name="Keywords" content="广安娱乐,游戏机生产,游戏机销售,电脑游戏机配件,超级机板王,卡带,游艺机,百家乐,明星97,老虎机" />
...
<SCRIPT language=javascript>FoldAll();</SCRIPT>
	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" 
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td><img src="index/aboutus.gif" width="200" height="18"></td>
		  </tr>
		  <tr>
...
<a href="eintro.asp">More&gt;&gt;</a></td>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td><img src="images/main_news.jpg" width="565" height="45" border="0"></td>
		  </tr>
		  <tr>
			<td><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
			  <tr>
				<td>
				<table width="95%"  border="0" align="left" cellpadding="0" cellspacing="0" class="zhengwen">
					   <% 
				news_type = "News"
	sql="select top 5 news.* from news,News_Class where news.news_class_id=news_class.news_id and news_language=0 and news_type = '"&news_type&"' order by news_date desc"
	set rs=server.createobject("adodb.recordset")
	rs.open sql,conn,1,1
	if not rs.eof then
	  while not rs.eof
	%>	
	  <tr>
		<td height="26" class="b-1-gray">  &nbsp;<img src="images/doc.jpg" width="10" height="10">&nbsp;<a href="Demo_ShowNews.asp?news_id=<%=rs("news_id")%>"> <%= left(rs("news_title"),16) %></a></td>

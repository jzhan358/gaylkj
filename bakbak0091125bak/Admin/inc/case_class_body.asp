...
sql="select * from case_class order by p_id ASC"
...
<table align="center" width="98%" border="1" cellspacing="0" cellpadding="4" bordercolor="#C0C0C0" style="border-collapse: collapse">
        <tr> 
          <td bgcolor="#E8E8E8">案例分类</font></td>
        </tr>
...
Do While Not rs.EOF and i<newsperpage%>
        <tr> 
          ...
          <td bgcolor="#FFFFFF" class="chinese" align="center"><a href="admin_case_class.asp?id=<%=rs("p_id")%>&action=editp#editp">修改</a> 
            <a href="admin_case_class.asp?id=<%=rs("p_id")%>&action=delp#delp">删除</a></td>
        </tr>
<%i=i+1
rs.movenext
loop
...
End if%>
      ...
      <table align="center" width="98%" border="0" cellspacing="0" cellpadding="0">
	    <form name="form2" method="post" action="admin_case_class.asp">
        <tr>
...
%>
              <%=i%> 
              <%else%>
              <a href="admin_case_class.asp?page=<%=i%>"><%=i%></a> 
              <%End if
next
...
page=request("page")+1
End if%>
              <a href="admin_case_class.asp?page=<%=page%>" title="下一页">>></a> 
              <%End if%>
              &nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <form name="form1" method="post" action="">
          ...
          <tr> 
            <td bgcolor="#F5F5F5" class="chinese" height="30" align="center"> 
              ...
              <input type="reset" name="Reset" value="清空重填" class="button">
              [<a href="admin_case_class.asp">返回</a>] </td>
          </tr>
...
rs.open sql,conn,1,1%>
      <table align="center" width="98%" border="1" cellspacing="0" cellpadding="4" bordercolor="#C0C0C0" style="border-collapse: collapse">
        <form name="form1" method="post" action="">
          ...
          <tr> 
            <td bgcolor="#FFFFFF" class="chinese">分类名称: <%=rs("p_type")%> 
            </td>
          </tr>
          <tr> 
            <td bgcolor="#F5F5F5" class="chinese" height="30" align="center"> 

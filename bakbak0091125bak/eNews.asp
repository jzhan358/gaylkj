...
news_type = "News"
sql="select top 20 news.* from news,News_Class where news.news_class_id=news_class.news_id and news_language=1 and news_type = '"&news_type&"' order by news_date desc"
set rs=server.createobject("adodb.recordset")
rs.open sql,conn,1,1
if not rs.eof then
  do while not rs.eof
%>
  <tr>
	<td width="20"> 
      <p align="center"> <img src=images/i4.gif width="10" height="12" border='0'></p>
    </td>
	<td><a href="eShowNews.asp?news_id=<%=rs("news_id")%>"><%=rs("news_title")%></a></td>    
	<td>　<%=rs("news_date")%></td>
  </tr>
<%rs.movenext
  loop
...
%>
  <tr>
	...
	<td width="331" height="22" align="center">　</td>
  </center>
	<td width="131" align="center">
      <p align="left">&nbsp;&nbsp; <a href="Demo_eNewsMore.asp?newstype=<%=news_type%>">More...</a></p>   
                                      </td>
  </tr>
  <center>
<%
